...
> Άνοιγμα αυτής της σελίδας στο [https://ierotheos10.github.io/magic-trick/](https://ierotheos10.github.io/magic-trick/)
...
* αναζήτηση για **https://github.com/ierotheos10/magic-trick** και εισαγωγή

## Επεξεργασία αυτού του έργου ![Σήμα κατάστασης κατασκευής](https://github.com/ierotheos10/magic-trick/workflows/MakeCode/badge.svg)

Για επεξεργασία αυτού του αποθετηρίου στο MakeCode.

* άνοιγμα [https://makecode.microbit.org/](https://makecode.microbit.org/)
* κάντε κλικ στην **Εισαγωγή** και έπειτα στην **Εισαγωγή διεύθυνσης URL**
* επικολλήστε **https://github.com/ierotheos10/magic-trick** και κάντε κλικ στην εισαγωγή
...
![Προβολή απόδοσης των μπλοκ](https://github.com/ierotheos10/magic-trick/raw/master/.github/makecode/blocks.png)
